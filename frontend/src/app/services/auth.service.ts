...
export class AuthenticationService {
    ...
    public forgotPassword(model:ForgotPassword){
        return this.httpService.postFullRequest(`${this.routePrefix}/accounts/forgot-password`,model);
    }

    public resetPassword(model:ResetPassword){
        return this.httpService.postFullRequest(`${this.routePrefix}/accounts/reset-password`,model);
    }
